...
import { removeVNodeDom, createVNode, createComponentVNode, mount, findDomFromVNode, patch as patch$1, unmount as unmount$1, Component as Component$1, callAll } from 'intact';
import { createApp, h, KeepAlive, getCurrentInstance, Comment, camelize, isVNode, Fragment, vShow, isRef, createVNode as createVNode$1 } from 'vue';
import { isInvalid, isStringOrNumber, isArray, hasOwn, isFunction, isString, EMPTY_OBJ } from 'intact-shared';
...
function normalize(vnode) {
    ...
    if (isIntactComponent(vnode)) {
        ...
        vNode = createComponentVNode(4, type.Component, props, vnode.key, props.ref);
    }
    else {
        ...
        // }
        vNode = createComponentVNode(4, Wrapper, { vnode: vnode }, vnode.key);
    }
...
function normalizeEvents(props, key, value) {
    ...
    var changeCallback = function (propName) { return function (v) {
        ...
        var _a = props[modifiersKey] || EMPTY_OBJ, number = _a.number, trim = _a.trim;
        if (trim) {
            v = String(v).trim();
        }
        else if (number) {
...
function functionalWrapper(Component) {
    function Ctor(props, context) {
        if (context) {
            // invoked by Vue
            var forwardRef = props.forwardRef, rest = __rest(props, ["forwardRef"]);
        ...
        get: function () {
            ...
            return (Ctor.__cache = {
                ...
                render: function (proxyToUse, renderCache, props, setupState) {
                    ...
                    var subTree = createVNode$1(Comment);
                    ...
                    if (!vueInstance.isMounted) {
                        ...
                        var element_1 = findDomFromVNode(vNode, true);
                        ...
                        patch$1(lastVNode, vNode, this.$el.parentElement, parentComponent, isSVG, null, mountedQueue, false);
                        // element may have chagned
                        var element = findDomFromVNode(vNode, true);
